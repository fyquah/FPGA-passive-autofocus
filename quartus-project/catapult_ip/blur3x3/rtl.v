...
//  Generated date: Thu Apr 30 17:04:25 2015
// ----------------------------------------------------------------------
...
module mean_vga_core (
  clk, en, arst_n, vin_rsc_mgc_in_wire_en_ld, vin_rsc_mgc_in_wire_en_d, vout_rsc_mgc_out_stdreg_en_ld,
      vout_rsc_mgc_out_stdreg_en_d, sum_rsc_mgc_out_stdreg_en_ld, sum_rsc_mgc_out_stdreg_en_d
);
  input clk;
  input en;
  input arst_n;
  ...
  output vout_rsc_mgc_out_stdreg_en_ld;
  reg vout_rsc_mgc_out_stdreg_en_ld;
  output [29:0] vout_rsc_mgc_out_stdreg_en_d;
  reg [29:0] vout_rsc_mgc_out_stdreg_en_d;
  output sum_rsc_mgc_out_stdreg_en_ld;
  reg sum_rsc_mgc_out_stdreg_en_ld;
  output [29:0] sum_rsc_mgc_out_stdreg_en_d;
  reg [29:0] sum_rsc_mgc_out_stdreg_en_d;
  ...
  reg main_stage_0_2;
  reg [8:0] FRAME_slc_26_itm_2;
  reg [8:0] FRAME_slc_44_itm_2;
  ...
  assign nl_FRAME_acc_itm = conv_u2s_7_8(FRAME_p_1_sva_1_mx0w0[18:12]) + 8'b10110101;
  ...
  assign nl_FRAME_acc_14_psp_sva = (conv_s2s_13_14(conv_u2s_12_13({reg_slc_getPixel_acc_11_psp_33_itm_1_cse
      ...
      slc_gx_itm_1}) , 1'b1}) + conv_s2s_8_10({FRAME_slc_23_itm_1 , FRAME_nand_itm_1}))))))
      ...
      , 1'b0 , reg_slc_getPixel_acc_11_psp_17_itm_1_cse , 1'b0 , reg_slc_getPixel_acc_11_psp_17_itm_1_cse})
      + conv_u2u_9_10(FRAME_slc_26_itm_2))})) + ({reg_slc_getPixel_acc_11_psp_22_itm_1_cse
  ...
  assign nl_FRAME_acc_13_tmp = (conv_s2s_13_14(conv_u2s_12_13({reg_slc_getPixel_acc_psp_33_itm_1_cse
      ...
      slc_gy_itm_1}) , 1'b1}) + conv_s2s_8_10({FRAME_slc_41_itm_1 , FRAME_nand_1_itm_1}))))))
      ...
      , 1'b0 , reg_slc_getPixel_acc_psp_17_itm_1_cse , 1'b0 , reg_slc_getPixel_acc_psp_17_itm_1_cse})
      + conv_u2u_9_10(FRAME_slc_44_itm_2))})) + ({reg_slc_getPixel_acc_psp_22_itm_1_cse
  ...
  assign mux_10_nl = MUX_v_13_2_2({(FRAME_acc_13_tmp[12:0]) , ((~ (FRAME_acc_13_tmp[12:0]))
      + 13'b1)}, FRAME_acc_13_tmp[13]);
  assign nl_FRAME_acc_7_psp_sva = conv_s2s_14_15(FRAME_mux_2_nl) + conv_u2s_13_15(mux_10_nl);
  ...
  assign or_dcpl = ~(main_stage_0_2 & (fsm_output[1]));
  assign and_dcpl = main_stage_0_2 & (fsm_output[1]);
  always @(posedge clk or negedge arst_n) begin
    if ( ~ arst_n ) begin
      sum_rsc_mgc_out_stdreg_en_d <= 30'b0;
      sum_rsc_mgc_out_stdreg_en_ld <= 1'b0;
      vout_rsc_mgc_out_stdreg_en_d <= 30'b0;
      vout_rsc_mgc_out_stdreg_en_ld <= 1'b0;
      ...
      if ( en ) begin
        sum_rsc_mgc_out_stdreg_en_d <= MUX_v_30_2_2({tmp_sum_1_sva_1 , sum_rsc_mgc_out_stdreg_en_d},
            or_dcpl | (~ exit_FRAME_sva_1_st_1));
        sum_rsc_mgc_out_stdreg_en_ld <= and_dcpl & exit_FRAME_sva_1_st_1;
        vout_rsc_mgc_out_stdreg_en_d <= MUX_v_30_2_2({({(({18'b0 , (~ FRAME_slc_1_itm_1)})
            | (signext_19_3(res_1_lpi_1_dfm_1_mx0[13:11]))) , (FRAME_p_slc_FRAME_p_2_itm_1
            | (res_1_lpi_1_dfm_1_mx0[10])) , (res_1_lpi_1_dfm_1_mx0[9:0])}) , vout_rsc_mgc_out_stdreg_en_d},
            or_dcpl);
        vout_rsc_mgc_out_stdreg_en_ld <= and_dcpl;
        vin_rsc_mgc_in_wire_en_ld <= 1'b1;
        exit_FRAME_sva_1_st_1 <= ~ (FRAME_acc_itm[7]);
        FRAME_and_itm_1 <= tmp_sum_1_sva_1 & ({{29{main_stage_0_2}}, main_stage_0_2})
            & (signext_30_1(~ exit_FRAME_sva));
        FRAME_slc_1_itm_1 <= readslicef_19_1_18(((~ FRAME_p_1_lpi_1_dfm) + 19'b100101100000000001));
        ...
        FRAME_slc_41_itm_1 <= readslicef_8_7_1((conv_s2s_6_8({(~ (getPixel_acc_psp[3]))
        ...
        FRAME_slc_44_itm_2 <= readslicef_10_9_1((({(getPixel_acc_psp[7]) , 1'b0 ,
        ...
        FRAME_slc_23_itm_1 <= readslicef_8_7_1((conv_s2s_6_8({(~ (getPixel_acc_42_psp[3]))
        ...
        FRAME_slc_26_itm_2 <= readslicef_10_9_1((({(getPixel_acc_42_psp[7]) , 1'b0
        ...
        FRAME_p_1_sva_1 <= MUX_v_19_2_2({FRAME_p_1_sva_1 , FRAME_p_1_sva_1_mx0w0},
            fsm_output[1]);
        exit_FRAME_sva <= MUX_s_1_2_2({exit_FRAME_sva , (~ (FRAME_acc_itm[7]))},
            fsm_output[1]);
  ...
  function [18:0] signext_19_3;
    input [2:0] vector;
  begin
    signext_19_3= {{16{vector[2]}}, vector};
  end
  endfunction
...
module mean_vga (
  vin_rsc_z, vin_rsc_lz, vout_rsc_z, vout_rsc_lz, sum_rsc_z, sum_rsc_lz, flag_rsc_z,
      clk, en, arst_n
);
  ...
  wire vout_rsc_mgc_out_stdreg_en_ld;
  wire [29:0] vout_rsc_mgc_out_stdreg_en_d;
  wire sum_rsc_mgc_out_stdreg_en_ld;
  wire [29:0] sum_rsc_mgc_out_stdreg_en_d;
  ...
  mgc_out_stdreg_en #(.rscid(2),
  .width(30)) vout_rsc_mgc_out_stdreg_en (
      .ld(vout_rsc_mgc_out_stdreg_en_ld),
      .d(vout_rsc_mgc_out_stdreg_en_d),
      .lz(vout_rsc_lz),
      .z(vout_rsc_z)
    );
  mgc_out_stdreg_en #(.rscid(3),
  .width(30)) sum_rsc_mgc_out_stdreg_en (
      .ld(sum_rsc_mgc_out_stdreg_en_ld),
      .d(sum_rsc_mgc_out_stdreg_en_d),
      .lz(sum_rsc_lz),
      .z(sum_rsc_z)
    );
  ...
  mean_vga_core mean_vga_core_inst (
      ...
      .vout_rsc_mgc_out_stdreg_en_ld(vout_rsc_mgc_out_stdreg_en_ld),
      .vout_rsc_mgc_out_stdreg_en_d(vout_rsc_mgc_out_stdreg_en_d),
      .sum_rsc_mgc_out_stdreg_en_ld(sum_rsc_mgc_out_stdreg_en_ld),
      .sum_rsc_mgc_out_stdreg_en_d(sum_rsc_mgc_out_stdreg_en_d)
    );
endmodule
